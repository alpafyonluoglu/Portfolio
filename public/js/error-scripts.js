...
let theme = {
    colorAccent: '#8e8e93',
    colorSelection: '#2c2c2e',
    colorCanvas: 'rgb(28, 28, 30)'
};
let spirograph;
window.onload = function () {
    ...
    plotSpirograph({R1: 30, R2: 80, r: 300, rotationCount: 10, sensitivity: 0.01, color: '#fafafa', lineWidth: 3});
}
...
function updateTheme(theme) {
    ...
    root.style.setProperty('--selection', theme.colorSelection);
...
function updateTopSectionSize() {
    ...
    top.style.height = screenHeight - 1 + "px";
